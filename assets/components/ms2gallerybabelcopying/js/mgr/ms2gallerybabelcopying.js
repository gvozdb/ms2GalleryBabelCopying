...
Ext.onReady(function () {
    ...
    var toolbar = Ext.getCmp('ms2gallery-page-toolbar'); // id ресурса - toolbar.record.id
    var babelBtn = Ext.getCmp('babel-language-select');

    if (toolbar != undefined && babelBtn != undefined) {
        // console.log(toolbar);
        // console.log(babelBtn);
        // console.log(babelBtn.initialConfig.menu);

        var menus = babelBtn.initialConfig.menu;
