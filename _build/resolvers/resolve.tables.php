...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('ms2gallerybabelcopying_core_path', null, $modx->getOption('core_path') . 'components/ms2gallerybabelcopying/') . 'model/';
            $modx->addPackage('ms2gallerybabelcopying', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/ms2gallerybabelcopying/model/schema/ms2gallerybabelcopying.mysql.schema.xml';
